...
namespace UltimateHeroes
{
    ...
    public class UltimateHeroes : BasePlugin, IPluginConfig<Config>
    {
        ...
        public override void Load(bool hotReload)
        {
            ...
            // ============================================
            // Reflection = Zur Laufzeit Klassen automatisch finden und registrieren
            // Vorteil: Keine hardcoded Listen mehr! Neue Heroes/Skills werden automatisch erkannt.
            
            // Auto-register Heroes via Reflection (generisch - keine hardcoded Liste mehr!)
            _heroService.RegisterHeroesViaReflection();
            
            // Auto-register Skills via Reflection (generisch - keine hardcoded Liste mehr!)
            _skillService.RegisterSkillsViaReflection();
            
            // Auto-set EffectManager for skills that need it (via Reflection)
            SetEffectManagerForSkillsViaReflection();
            
            // Auto-set SpawnService for skills that need it (via Reflection)
