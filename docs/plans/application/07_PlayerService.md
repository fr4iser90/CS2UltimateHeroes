...
Der PlayerService verwaltet Player States:
...
### Datei: `Application/Services/PlayerService.cs`
...
1. **Event Handlers**: OnPlayerConnect, OnPlayerDisconnect, OnPlayerSpawn
2. **PlayerRepository**: Lädt/Speichert Player States
3. **BuildService**: Aktiviert Builds für Player
4. **SkillService**: Aktiviert Skills für Player
5. **XpService**: Updated Player XP/Level

## ✅ Tests

- Player wird korrekt erstellt
- Player wird korrekt geladen
- Player State wird korrekt gespeichert
- Player Cache funktioniert

## 📝 Nächste Schritte

1. ✅ IPlayerService Interface definieren
2. ✅ PlayerService.cs implementieren
